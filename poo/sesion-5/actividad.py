...
# Cambiar el nombre y nacionalidad del creador de los Simpson de Comse Fulatino
# a Matt Groening y de Wakandiano a Americano
...
print(canales["Star Channel"]["series"]["Los Simpson"].items())

#Comparar el numero de episodios de la teoria del big bang vs two and a half man. Usen operadores booleanos

capBigBang = canales["Warner"]["series"]["The Big Bang Theory"]["capitulos"]
capTwoAndH = int(canales["Warner"]["series"]["Two and a Half Men"]["capitulos"])
print(capBigBang == capTwoAndH)

#En Southpark, cambiar el tag de "Desnudos" por "Contenido Educativo"

canales["Comedy Central"]["series"]["South Park"]["tags"] = ("Comedia", "Violencia", "Contenido Educativo")
...
suma = sum([int(numCap["capitulos"]) for numCap in canales["Warner"]["series"].values()])
print(suma)
...
canales["Adult Swim"]["series"]["Celebrity Deathmatch"] = { "año de creacion":1998,
                                                        	"temporadas":6,
                                                        	"capitulos":93,
                                                        	"calificacion":9,
                                                        	"creador":{
...
print(canales["Adult Swim"]["series"]["Celebrity Deathmatch"])


# Obtener el promedio de calificaciones de las series de Warner. 
numSeries = len(canales["Warner"]["series"])
sumSeries = sum([int(cap["calificacion"]) for cap in canales["Warner"]["series"].values()])

promCal = sumSeries/numSeries
print(promCal)
