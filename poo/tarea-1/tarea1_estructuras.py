...
#2 Imprimir el nombre del Art Director de Cyberpunk 2077
print(videojuegos["CD Projekt Red"][0]["Cyberpunk 2077"]["equipo"]["Art Director"])
...
#4 Imprimir el segundo tag de Cyberpunk 2077
print(videojuegos["CD Projekt Red"][0]["Cyberpunk 2077"]["tags"][1])

#5 Calcular el numero de ventas totales de los juegos de 343 Industries
suma = sum([int(list(videojuego.values())[0]["ventas mundiales"]) for videojuego in videojuegos["343 Industries"]])
print(suma)

#6 Calcular el promedio de calificaciones de juegos de CD Projekt Red
numCalifs = len(videojuegos["CD Projekt Red"])
sumCalifs = sum([int(list(videojuego.values())[0]["calificacion"]) for videojuego in videojuegos["CD Projekt Red"]])
print(sumCalifs/numCalifs)
...
videojuegos["Epic Games"][0]["Gears of War 3"]["tags"].append("Juego de los god")
print(videojuegos["Epic Games"][0]["Gears of War 3"]["tags"])

#9 Cambiar el tag "aliens" de Halo infinite por "Espartans"
temp = videojuegos["343 Industries"][0]["Halo Infinite"]["tags"]
temp = list(temp)
temp[1] = "Espartans"
videojuegos["343 Industries"][0]["Halo Infinite"]["tags"] = tuple(temp)
print(videojuegos["343 Industries"][0]["Halo Infinite"]["tags"])
...
videojuegos["CD Projekt Red"][1]["Red Dead Redemption II"]["equipo"]["Music Director"] = "Juan Gabriel"
print(videojuegos["CD Projekt Red"][1]["Red Dead Redemption II"]["equipo"])
